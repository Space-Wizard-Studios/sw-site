export function Sun({ fillColor = 'black', ...props }) {
  return (
...
export function Moon({ fillColor = 'black', ...props }) {
  return (
...
export function Cloud({ fillColor = 'black', ...props }) {
  return (
    <svg {...props} xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMidYMid meet' viewBox='0 0 1024 1024'>
      <path
        fill={fillColor}
...
export function Stars({ fillColor = 'black', ...props }) {
  return (
    <svg {...props} xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMidYMid meet' viewBox='0 0 512 512'>
