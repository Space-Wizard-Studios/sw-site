...
export type ProjectService = NonNullable<NonNullable<CollectionEntry<'projects'>['data']['category']>['products']>[number];
export type ProjectPlatform = NonNullable<NonNullable<CollectionEntry<'projects'>['data']['category']>['platforms']>[number];
export type ProjectTag = NonNullable<NonNullable<CollectionEntry<'projects'>['data']['category']>['tags']>[number];
export type ProjectFramework = NonNullable<NonNullable<CollectionEntry<'projects'>['data']['category']>['frameworks']>[number];

export type ProjectPartner = NonNullable<CollectionEntry<'projects'>['data']['partners']>[number];
